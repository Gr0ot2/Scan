<html>
  <head>
    <meta charset="utf-8">
    <link rel="stylesheet" type="text/css" href="pagina_herramientas.css">
  ...
  <body>
      ...
      <div id="photos">
       <div id="photo_rasqueta">
      <h2 id="rasqueta">Rasqueta</h2>
		<a href="rasqueta.jsp">
      <img id=photo1 src="img/rasqueta.jpeg"/>
      </a>
      </div>  
      <div id="photo_cepillo">
      <h2 id="cepillo">cepillo</h2>
      <a href="cepillo.jsp">
      <img id="photo2" src="img/cepillo.jpeg"/>
      </a>
      </div>
       <div id="photo_bruza">
      <h2 id="bruza">Bruza</h2>
      <a href="bruza.jsp">
      <img id="photo3" src="img/bruza.jpg"/>
      </a>
      </div>
       <div id="photo_cepillo_crines">
      <h2 id="cepillo_crines">cepillo crines</h2>
      <a href="cepillo_crines.jsp">
      <img id="photo4" src="img/cepillo_crines.jpg"/>
      </a>
      </div>
      <div id="photo_limpia_casco">
      <h2 id="limpia_casco">limpia cascos</h2>
      <a href="limpia_casco.jsp">
      <img id="photo5" src="img/limpia_cascos.jpeg"/>
      </a>
      </div> 
      </div>
  </body>
